...
<div class="wrap">
	...
	<!-- logo par med anes mazouni-->
		<h1><a href="../../index.php"><img title="pourcentagen"src="../../images/logo.png" alt=""></a></h1>
	</div>
</div>
</div>
<div class="nav_bg">
...
<div class="menu2">
		<ul class="nav2">
		<!-- police changer par med amine trabelsi / med anes mazouni -->
			<li class="active"><a href="../gestionClient/ajoutClient.php">Ajout Client</a></li>
			<li><a href="../gestionClient/gestionClient.php">Liste Client</a></li>
...
<div class="main">
<div class="content">
<div class="titregestion">Ajout Des Clients </div>
<div width="60%">
		<div class="contact-form" ><center>
			<form method="post" action="ajout.php" name="formClient">
				<div><label><span>NOM <input type="text" name="nom" id="nom"class="textbox"/></span></label></div>
				<div><label><span>PRENOM <input type="text" name="prenom" id="prenom"class="textbox"/></span></label></div>
				<div><label><span>TEL <input type="text" name="tel" id="tel"class="textbox"/></span></label></div>
				<div><label><span>MAIL <input type="text" name="mail" id="mail"class="textbox"/></span></label></div>
				<div><label><span>LOGIN <input type="text" name="login" id="login"class="textbox"/></span></label></div>
				<div><label><span>PASSWORD <input type="text" name="password" id="password"class="textbox"/></span></label></div>
				<div><label><span>TOKEN <input type="text" name="token" id="token"class="textbox"/></span></label></div>
				<input type="button" value="Ajouter" onclick="verifierClient()"class="btn btn-3 btn-3e icon-arrow-right"> <input type="reset" value="Annuler"class="btn btn-3 btn-3e icon-arrow-right">
			</form>
		</center>
		</div>
