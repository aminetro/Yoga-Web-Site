...
<div class="menu">
		...
		<div class="menu2">
			<ul class="nav2">
				...
				<li class="active"><a href="modif.php?log=<?php echo $_SESSION['logc']; ?>">Modify</a></li>
...
<div class="main">
	...
	include("admin/connexion.php");		
		...
		<form method="post" action="modifier.php">
			...
			<div><label><span>LAST NAME <input type="text" name="nom" value="<?php echo $ligne2['nom']; ?>"class="textbox"/> </span></label></div>
			<div><label><span>FIRST NAME <input type="text" name="prenom" value="<?php echo $ligne2['prenom']; ?>"class="textbox"/></span></label></div>
			<div><label><span>MOBILE <input type="text" name="tel" value="<?php echo $ligne2['tel']; ?>"class="textbox"/></span></label></div>
			<div><label><span>E-MAIL <input type="text" name="mail" value="<?php echo $ligne2['mail']; ?>"class="textbox"/></span></label></div>
			<input type="hidden" name="login" value="<?php echo $ligne2['login']; ?>"/>
			<div><label><span>PASSWORD <input type="password" name="password" value="<?php echo $ligne2['password']; ?>"class="textbox"/></span></label></div>
			<input type="hidden" name="token" value="<?php echo $ligne2['token']; ?>"/><br/>

			
			

			<button  onclick=""class="btn btn-3 btn-3e icon-arrow-right">Modify</button>
		</form>
		</div>
		</div>
		<?php  }?>
