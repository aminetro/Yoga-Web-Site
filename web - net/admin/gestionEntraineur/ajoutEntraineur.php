...
<div class="menu2">
		<ul class="nav2">
		<!-- police changer par med amine trabelsi / med anes mazouni -->
			<li class="active"><a href="../gestionEntraineur/ajoutEntraineur.php">Ajout Entraineur</a></li>
			<li><a href="../gestionEntraineur/gestionEntraineur.php">Liste Entraineur</a></li>
...
<div class="main">
<div class="content">
<div class="titregestion">Ajout Des Entraineurs </div>
<div width="60%">
		<div class="contact-form" ><center>
			<form method="post" action="ajout.php" name="formEntraineur">
				...
				<div><label><span>SPECIALITE <input type="text" name="spec" id="spec"class="textbox"/></span></label></div>
				<input type="button" value="Ajouter" onclick="verifierEntraineur()"class="btn btn-3 btn-3e icon-arrow-right"> <input type="reset" value="Annuler"class="btn btn-3 btn-3e icon-arrow-right">
			</form>
				</center>
		</div>
