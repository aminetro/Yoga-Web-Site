...
<div class="menu2">
		...
		<!-- police changer par med amine trabelsi / med anes mazouni -->
			...
			<li class="active"><a href="../gestionClient/reclamation.php">Reclamation</a></li>
		<div class="clear"></div>
		</ul>
</div>
</div>
...
<div class="tableau">
		...
		<tr> <td> ID </td>  <td>MAIL</td> <td>TITRE</td><td>MESSAGE</td> <td> SUPPRIMER </td> <td> MODIFIER </td> <td> REPONDRE </td>  </tr>
		<?php while ($ligne=mysql_fetch_array($resultat)) { ?>

			<tr> 
				<td><?php echo $ligne['id']; ?></td>  
				<td><?php echo $ligne['mail'] ;?></td> 
				<td><?php echo $ligne['subject'] ;?></td>
				<td><?php echo $ligne['message']; ?></td>  
				<td> <a href="reclamation.php?choix=supprim&idr=<?php echo $ligne['id']; ?>"><img title="emotionnel"src="../../images/bouton-supprim.png"></a></td>
				<td> <a href="reclamation.php?choix=modif&idr=<?php echo $ligne['id']; ?>"><button class="btn btn-3 btn-3e icon-arrow-right">modifier</button></a></td>
				<td> <a href="reclamation.php?choix=repond&idr=<?php echo $ligne['id']; ?>"><button class="btn btn-3 btn-3e icon-arrow-right">repondre</button></a></td>
			</tr>
		...
		if (isset ($_GET['choix']))
		{
			...
			$idr=$_GET['idr'];
		if($x=="supprim"){
		$requete="DELETE  FROM reclamation where id='$idr'";
		...
		$requete1="select * from reclamation where id='$idr';";
		...
		<form method="post" action="modif.php">
			...
			<div><label><span>SUBJECT <input type="text" name="subject" value="<?php echo $ligne1['subject']; ?>"class="textbox"/></span></label></div>
		...
		$requete2="select * from reclamation where id='$idr';";
