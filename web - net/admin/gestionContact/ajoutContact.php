...
<div class="wrap">
	...
	<!-- logo par med anes mazouni-->
		<h1><a href="../../index.php"><img title="breathing"src="../../images/logo.png" alt=""></a></h1>
	</div>
</div>
</div>
<div class="nav_bg">
...
<div class="menu2">
		<ul class="nav2">
		<!-- police changer par med amine trabelsi / med anes mazouni -->
			<li class="active"><a href="../gestionContact/ajoutContact.php">Ajout Message</a></li>
			<li><a href="../gestionContact/contactreponse.php">Liste Message</a></li>
...
<div class="main">
<div class="content">
<div class="titregestion">Ajout Des Messages </div>
<div width="60%">
		<div class="contact-form" ><center>
			<form method="post" action="ajout.php" name="formContact">
				...
				<div><label><span>MESSAGE : <textarea name="message" id="message"></textarea> </label><br/><br/></div>
				<input type="button" value="Ajouter" onclick="verifierContact()"class="btn btn-3 btn-3e icon-arrow-right"> <input type="reset" value="Annuler"class="btn btn-3 btn-3e icon-arrow-right">
			</form>
			</center>
